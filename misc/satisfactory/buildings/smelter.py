...
class Smelter:
	"""	__init__(clock=100, target=None)
		clock -- The percentage clock rate of the smelter, where clock in [0,250]
	...
	recipes = {
		"iron_ingot": {"input": {"iron_ore": 30}, "output": {"iron_ingot": 30}},
		"copper_ingot": {"input": {"copper_ore": 30}, "output": {"copper_ingot": 30}},
		"caterium_ingot": {"input": {"caterium_ore": 45}, "output": {"caterium_ingot": 15}}
	}
